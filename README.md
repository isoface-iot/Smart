...
Smart 智慧控制平臺，實現集中監控、資訊共用、智慧控制，與 ERP 企業經營管理系統協調互動。運行版僅供個人且非商業使用。
...
![](/images/smart_tutoral01.png)

在打開的Smart界面中，點選左上角的打開文件按鈕打開對話方塊。

![](images/smart_tutoral02.png)

在打開專案的對話方塊中，根據對應的編號選擇範例模板文件，然後點選`打開(O)`按鈕。

![](images/smart_tutoral03.png)
