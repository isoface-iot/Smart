...
{&(RES0__INSTANCE0.I_PB_DISCHARGE), BOOL_ENUM},
{&(RES0__INSTANCE0.Q_LIGHTPBFILL), BOOL_ENUM},
{&(RES0__INSTANCE0.Q_LIGHTPBDISCHARGING), BOOL_ENUM},
{&(RES0__INSTANCE0.IPOTENTIONMETERFILL), INT_ENUM},
{&(RES0__INSTANCE0.IPOTENTIONMETERDISCHARGE), INT_ENUM},
{&(RES0__INSTANCE0.ITANKMETERLEVEL), INT_ENUM},
{&(RES0__INSTANCE0.ITANKMETERFLOW), INT_ENUM},
{&(RES0__INSTANCE0.QFILLVALUE), INT_ENUM},
{&(RES0__INSTANCE0.QDISCHARGEVALUE), INT_ENUM},
{&(RES0__INSTANCE0.QTANKFILLVALUE), INT_ENUM},
{&(RES0__INSTANCE0.QTANKDISCHARGEVALUE), INT_ENUM},
{&(RES0__INSTANCE0.QLEVEL), INT_ENUM},
{&(RES0__INSTANCE0.QFLOWMETER), INT_ENUM},
{&(RES0__INSTANCE0.PBFILL_PRESSED), BOOL_ENUM},
{&(RES0__INSTANCE0.PBDISCHARGE_PRESSED), BOOL_ENUM},
{&(RES0__INSTANCE0.PBFILL_TRIG.EN), BOOL_ENUM},
{&(RES0__INSTANCE0.PBFILL_TRIG.ENO), BOOL_ENUM},
{&(RES0__INSTANCE0.PBFILL_TRIG.CLK), BOOL_ENUM},
{&(RES0__INSTANCE0.PBFILL_TRIG.Q), BOOL_ENUM},
{&(RES0__INSTANCE0.PBFILL_TRIG.M), BOOL_ENUM},
{&(RES0__INSTANCE0.PBDISCHARGE_TRIG.EN), BOOL_ENUM},
{&(RES0__INSTANCE0.PBDISCHARGE_TRIG.ENO), BOOL_ENUM},
{&(RES0__INSTANCE0.PBDISCHARGE_TRIG.CLK), BOOL_ENUM},
{&(RES0__INSTANCE0.PBDISCHARGE_TRIG.Q), BOOL_ENUM},
{&(RES0__INSTANCE0.PBDISCHARGE_TRIG.M), BOOL_ENUM},
{&(RES0__INSTANCE0.OLD_POTENTIONMETERFILL), INT_ENUM},
{&(RES0__INSTANCE0.OLD_POTENTIONMETERDISCHARGE), INT_ENUM}
};
